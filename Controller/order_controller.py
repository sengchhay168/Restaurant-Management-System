...
from Services import menu_service, order_service, table_service
                            ...
                            match sub_choice:
                                case "1":
                                    ...
                                    while True:
                                        ...
                                        # 3. Look up item from MenuService
                                        ...
                                        if menu_item:
                                            try:
                                                ...
                                                # 4. Use auto-fetched price directly from menu_item!
                                                items_list.append({
                                                    "item_id": menu_item.name,  # or menu_item.item_id
                                                    "quantity": quantity,
                                    ...
                                    # 5. Save order if items were added
                                    if items_list:
                                ...
                                case "4":
                                    ...
                                    if all_orders:
                                        ...
                                        print(" ⚠️ No order found in the System!")
                                ...
                                case "6":
                                    ...
                                    # Exit back to the main restaurant dashboard
                                    break
